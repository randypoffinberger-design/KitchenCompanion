const CACHE_NAME = 'kitchen-companion-v0.18.1';
const OCR_CACHE_NAME = 'kitchen-companion-ocr-tesseract-7.0.0-best-int';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.18.1', './kitchen-engine.js?v=0.18.1', './profile-storage.js?v=0.18.1', './meal-planner.js?v=0.18.1', './app.js?v=0.18.1',
  './url-recipe-import.js?v=0.18.1', './ocr-service.js?v=0.18.1', './alarm-bell.wav?v=0.18.1', './app.webmanifest?v=0.18.1', './icon-180.png?v=0.18.1', './icon-192.png?v=0.18.1', './icon-512.png?v=0.18.1'
];
const OCR_ASSETS = [
