const CACHE_NAME = 'serenity-kitchen-v0.19.0';
const OCR_CACHE_NAME = 'kitchen-companion-ocr-tesseract-7.0.0-best-int';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.19.0', './kitchen-engine.js?v=0.19.0', './profile-storage.js?v=0.19.0', './meal-planner.js?v=0.19.0', './app.js?v=0.19.0',
  './url-recipe-import.js?v=0.19.0', './ocr-service.js?v=0.19.0', './alarm-bell.wav?v=0.19.0', './app.webmanifest?v=0.19.0', './icon-180.png?v=0.19.0', './icon-192.png?v=0.19.0', './icon-512.png?v=0.19.0', './serenity-kitchen-icon-1024.png?v=0.19.0', './serenity-kitchen-home.jpeg?v=0.19.0'
];
const OCR_ASSETS = [
