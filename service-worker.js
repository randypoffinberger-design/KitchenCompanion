const CACHE_NAME = 'kitchen-companion-v0.16.6';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.16.6', './kitchen-engine.js?v=0.16.6', './profile-storage.js?v=0.16.6', './app.js?v=0.16.6',
  './ocr-service.js?v=0.16.6', './alarm-bell.wav?v=0.16.6', './app.webmanifest?v=0.16.6', './icon-180.png?v=0.16.6', './icon-192.png?v=0.16.6', './icon-512.png?v=0.16.6'
];
