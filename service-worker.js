const CACHE_NAME = 'serenity-kitchen-v0.21.2';
const OCR_CACHE_NAME = 'kitchen-companion-ocr-tesseract-7.0.0-best-int';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.21.2', './kitchen-engine.js?v=0.21.2', './profile-storage.js?v=0.21.2', './meal-planner.js?v=0.21.2', './sync-client.js?v=0.21.2', './app.js?v=0.21.2',
  './url-recipe-import.js?v=0.21.2', './ocr-service.js?v=0.21.2', './alarm-bell.wav?v=0.21.2', './app.webmanifest?v=0.21.2', './icon-180.png?v=0.21.2', './icon-192.png?v=0.21.2', './icon-512.png?v=0.21.2', './serenity-kitchen-icon-1024.png?v=0.21.2', './serenity-kitchen-home.jpeg?v=0.21.2', './sk-watermark.png?v=0.21.2'
];
const OCR_ASSETS = [
