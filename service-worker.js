const CACHE_NAME = 'serenity-kitchen-v0.20.6';
const OCR_CACHE_NAME = 'kitchen-companion-ocr-tesseract-7.0.0-best-int';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.20.6', './kitchen-engine.js?v=0.20.6', './profile-storage.js?v=0.20.6', './meal-planner.js?v=0.20.6', './app.js?v=0.20.6',
  './url-recipe-import.js?v=0.20.6', './ocr-service.js?v=0.20.6', './alarm-bell.wav?v=0.20.6', './app.webmanifest?v=0.20.6', './icon-180.png?v=0.20.6', './icon-192.png?v=0.20.6', './icon-512.png?v=0.20.6', './serenity-kitchen-icon-1024.png?v=0.20.6', './serenity-kitchen-home.jpeg?v=0.20.6', './sk-watermark.png?v=0.20.6'
];
const OCR_ASSETS = [
