const CACHE_NAME = 'kitchen-companion-v0.15.2';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.15.2', './kitchen-engine.js?v=0.15.2', './profile-storage.js?v=0.15.2', './app.js?v=0.15.2',
  './ocr-service.js?v=0.15.2', './alarm-bell.wav?v=0.15.2', './app.webmanifest?v=0.15.2', './icon-180.png?v=0.15.2', './icon-192.png?v=0.15.2', './icon-512.png?v=0.15.2'
];
