const CACHE_NAME = 'kitchen-companion-v0.16.1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.16.1', './kitchen-engine.js?v=0.16.1', './profile-storage.js?v=0.16.1', './app.js?v=0.16.1',
  './ocr-service.js?v=0.16.1', './alarm-bell.wav?v=0.16.1', './app.webmanifest?v=0.16.1', './icon-180.png?v=0.16.1', './icon-192.png?v=0.16.1', './icon-512.png?v=0.16.1'
];
