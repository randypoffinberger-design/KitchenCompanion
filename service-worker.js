const CACHE_NAME = 'kitchen-companion-v0.16.0';
const APP_SHELL = [
  './', './index.html', './styles.css?v=0.16.0', './kitchen-engine.js?v=0.16.0', './profile-storage.js?v=0.16.0', './app.js?v=0.16.0',
  './ocr-service.js?v=0.16.0', './alarm-bell.wav?v=0.16.0', './app.webmanifest?v=0.16.0', './icon-180.png?v=0.16.0', './icon-192.png?v=0.16.0', './icon-512.png?v=0.16.0'
];
